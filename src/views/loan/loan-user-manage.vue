<template>
  <div class="userInfo">
    <div class="search">
      <div class="item">
        <el-input size="small" placeholder="ID" suffix-icon="el-icon-date" v-model="email"></el-input>
      </div>
      <div class="item">
        <el-input size="small" placeholder="手机" suffix-icon="el-icon-date" v-model="email"></el-input>
      </div>
      <div class="item">
        <el-input size="small" placeholder="姓名" suffix-icon="el-icon-date" v-model="email"></el-input>
      </div>
      <div class="item">
        <el-input size="small" placeholder="请输入用户名" suffix-icon="el-icon-date" v-model="email"></el-input>
      </div>
      <div class="item">
