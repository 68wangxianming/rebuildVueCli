          ...
          <el-table-column type="expand">
            <template slot-scope="props">
              <el-form label-position="left" inline class="demo-table-expand">
                <el-form-item label="模板ID"><span>{{ props.row.email }}</span></el-form-item>
                <el-form-item label="模板编号"><span>{{ props.row.name }}</span></el-form-item>
                <el-form-item label="模板级别"><span>{{ props.row.roleName }}</span></el-form-item>
                <el-form-item label="借款额度下限"><span>{{ props.row.status }}</span></el-form-item>
                <el-form-item label="借款额度下限（Rp）"><span>{{ props.row.createTime }}</span></el-form-item>
                <el-form-item label="借款期限上限（天）"><span>{{ props.row.updateTime }}</span></el-form-item>
              </el-form>
            </template>
          </el-table-column>
          <el-table-column label="模板ID" prop="email"></el-table-column>
          <el-table-column label="模板编号" prop="name"></el-table-column>
          <el-table-column label="模板级别" prop="roleName"></el-table-column>
          <el-table-column label="借款额度下限" prop="status"></el-table-column>
